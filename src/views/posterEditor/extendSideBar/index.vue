...
<template>
  <div class="extend-side-bar">
    <div class="list">
      ...
      <el-tooltip
        effect="dark"
        content="Editor Setting"
        placement="left"
        transition="el-zoom-in-center"
      >
        <div class="item" @click="openSettingCenter('undo')">
      ...
      <!--        transition="el-zoom-in-center"-->
      <!--      >-->
      <!--        <div class="item" @click="collapseComponentControl()">-->
...
export default {
  ...
  methods: {
    ...
    collapseComponentControl() {
      this.collapsed = !this.collapsed
      this.$store.dispatch('poster/setControlCollapsed', this.collapsed)
    },
    exportH5() {
