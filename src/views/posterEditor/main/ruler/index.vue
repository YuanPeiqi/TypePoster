...
const LEFT_SIDE_WIDTH = 290 // 左侧边栏的宽度
const RULER_WIDTH = 21 // 标尺宽度
const HEADER_HEIGHT = 80 // HEADER高度
...
export default {
  ...
  computed: {
    ...
    columnXInRuler() {
      return this.columnX - RULER_WIDTH
    },
    rowYInRuler() {
      return this.rowY - 50
    },
  ...
  methods: {
    ...
    leftMouseEnter(e) {
      ...
      this.rowY = e.pageY - this.mainPanelScrollY - HEADER_HEIGHT
    },
    leftMouseMove(e) {
      this.rowY = e.pageY - this.mainPanelScrollY - HEADER_HEIGHT
    },
